...
#define JOB_CARGORILLA "Cargo Pack Beast"
//Service
...
#define JOB_DISPLAY_ORDER_CARGO_PACK_BEAST 22
...
/// Whether this is a rare job for ui indication
#define JOB_RARE_APPEARANCE (1<<9)
