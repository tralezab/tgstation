...
/client/verb/ooc(msg as text)
	...
	var/datum/commendation/commendation_type = prefs.read_preference(/datum/preference/choiced/commendation_type)
	if(commendation_type)
		var/datum/asset/spritesheet/sheet = get_asset_datum(/datum/asset/spritesheet/chat)
		keyname = "[sheet.icon_tag(initial(commendation_type.icon_tag))][keyname]"
