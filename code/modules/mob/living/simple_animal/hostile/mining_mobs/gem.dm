...
//rare lavaland monster that is immune to all damage. it tries to walk up to you, drop it's shields and blast an aoe of projectiles.

/mob/living/simple_animal/hostile/asteroid/gem
	name = "possessed gem"
	desc = "a polished soul shard embedded in a golden bezel. Some spirit from the necropolis is inside."
	...
	mob_biotypes = MOB_MINERAL //it's a flying gem
	move_to_delay = 5
	ranged = TRUE
	ranged_cooldown_time = 30
	throw_message = "is deflected by the golden bezel of"
	vision_range = 5 //you don't have to fight it, only attacks when you get close
	speed = 5
	maxHealth = 150
	health = 150
...
/obj/projectile/gem_bolt
	name ="necropolis bolt"
	icon_state= "gem_bolt"
	damage = 20
