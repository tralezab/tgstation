/mob/living/basic/waxweaver
	name = "waxweaver"
	desc = "The powerhouse of the hive, or something. Buries itself into wax to get the jump on intruders."
	...
	ai_controller = /datum/ai_controller/basic_controller/waxweaver
