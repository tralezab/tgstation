/datum/species/pod
	...
	mutantheart = /obj/item/organ/heart/podcore

/obj/item/organ/heart/podcore
	name = "earthly core"
	desc = "A grassy, earthy core from a podperson that allows them to heal in the light. All podpeople will wither without this."
	icon_state = "podheart-on"
	icon_base = "podheart"

/obj/item/organ/heart/podcore/on_life()
	..()
	if(owner.stat == DEAD)
		return
