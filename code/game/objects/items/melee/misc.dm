...
/obj/item/melee/synthetic_arm_blade/Initialize()
	. = ..()
	AddComponent(/datum/component/butchering, speed = 6 SECONDS, effectiveness = 80) //very imprecise
...
/obj/item/melee/sabre/Initialize()
	. = ..()
	AddComponent(/datum/component/butchering, speed = 3 SECONDS, effectiveness = 95, bonus_modifier = 5) //fast and effective, but as a sword, it might damage the results.
