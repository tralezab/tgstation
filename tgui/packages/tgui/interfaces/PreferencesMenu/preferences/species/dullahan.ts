...
const Dullahan: Species = {
  ...
  lore: "\"No wonder they're all so grumpy! Their hands are always full! \
    I used to think, \"wouldn't this be cool?\" but after watching these \
    creatures suffer from their head getting dunked down disposals for the nth \
    time, I've reconsidered if that's the kind of world I would want to \
    be.\" - Captain Larry Dodd",
};
