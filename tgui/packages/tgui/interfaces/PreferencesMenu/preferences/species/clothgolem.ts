...
const Mummy: Species = {
  ...
  lore: "Mummies are very self conscious. They're shaped weird, they walk \
    slow, and worst of all, they're considered the laziest halloween costume. \
    But that's not even true, they say. Making a mummy costume may be easy, \
    but making a CONVINCING mummy costume requires things like proper fabric \
    and purposeful staining to achieve the look. Which is FAR from easy.",
};
